...
版の付け方は Q49（意味つき版 MAJOR.MINOR.PATCH。表を持つ規則は、表の正準 JSON の SHA-256 も記す）。状態と採用の経緯は `DECISIONS.md` にある。
...
| PATTERNS | 0.1.1（49件・表 `92666827…`）・照合 PATTERNS-MATCH-1.0.0 | 一覧は確定（著者承認 2026-09-18。0.1.0＝47件は撤回） | 2〜4 | [PATTERNS.md](PATTERNS.md) |
