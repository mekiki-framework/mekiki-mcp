...
| PATTERNS | 0.2.0（50件。表の SHA-256 は [PATTERNS.md](PATTERNS.md)）・照合 PATTERNS-MATCH-1.0.0 | 一覧は確定（著者承認 2026-09-18。0.1.0＝47件は撤回、0.1.1＝49件→0.2.0 で P31・P39 の語形追加と P54 新設） | 2〜4 | [PATTERNS.md](PATTERNS.md) |
