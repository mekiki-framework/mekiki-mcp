...
**公開**：P01 Space 再起動後に再接続し、復帰までの時間を記録（2026-09-19 実測 17秒。休止からの復帰は未実測と明記し、公開後に測る）。P02 Space の URL で M01〜M03 と E01 二問（R01・R14）を Claude Code から実施。P03 Claude Desktop（Custom Connector・遠隔 HTTPS）と ChatGPT 開発者モードから `list_papers`。
