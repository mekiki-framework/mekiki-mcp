...
各問について、**ja / en × ガイド条件なし / `read_with_guards`**（英語は `read_with_guards_en`）の4通りを記録する（R01・R08・R13・R14・R15 で計20件）。
**配置段階一は12本**（ja で五問 × 二条件＝10本＋en で R01・R14 をガード条件で＝2本）で始め、2026-09-19 に残り8本を足して20本にした。

### R<番号> — <言語> — ガイド条件：<なし / read_with_guards / read_with_guards_en>
